...
<head>
  <meta charset="utf-8">
  <title>online Marriage Site</title>
  ...
  <link href="css/style.css" rel="stylesheet">
    ...
    <link href="../lib/bootstrap/css1/bootstrap.css" rel="stylesheet">
...
<body class="page-index has-hero">
  ...
  <div id="background-wrapper" class="buildings" data-stellar-background-ratio="0.1">
    ...
    <div id="navigation" class="wrapper">
          ...
          <div class="row">
            <div class="col-md-8 pb-3">
              ...
              <a class="navbar-brand" href="index.php" title="Home"> 
                   <img src="bdlogo.png" alt="BD Govt" style="height: 75px;width: 75px;">
      ...
      <li><a href="bridegroom/index.php">Find bridegroom</a>  
      </li>
        <li class="dropdown">
