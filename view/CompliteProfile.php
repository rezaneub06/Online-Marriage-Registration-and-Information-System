...
<body class="benches" id="background-wrapper">
    ...
    <div id="logodiv">
        <div id="logo2">
            <div class="col-md-2 pb-3">
             ...
             <div class="col-md-8 navbar-Brand pad">
                  <h3 class="text-light font"><span> Online&nbsp; Marriage &nbsp;Registration&nbsp; and&nbsp; Information&nbsp; System</h3></span>
             </div>
            <div class="col-md com">
                   <p style="color: red;">complete profile for better response</p>
