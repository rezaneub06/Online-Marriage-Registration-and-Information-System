		 ...
		 ?>
          ...
          <div>
            <div class="card mt-5 shadow">
            	<h3 class="mt-5 mx-5 text-center text-danger">Replay Donner Request</h3>
            	<hr class="bg-danger">
            	<div class="">
	              	<form class="mx-auto m-5 col-lg-5" action="send_mail.php" method="post">
						<div class="form-group">
							<label>TO</label>
							<input class="form-control" type="email" name="email" value="<?php echo $getData['email']?>" placeholder="Type Donner Email"><br>
						</div>
						<div class="form-group">
							<label>Subject</label>
							<input class="form-control" type="text" name="sub" value="Blood Request Response" placeholder="Type Email Subject">
						</div>
						<div class="form-group">
							<label>Message</label>
							<textarea class="form-control" rows="7" type="text"  name="mgs" placeholder="Type your message"></textarea>
						</div>
						<div class="form-group">
							<input type="submit" class="btn btn-danger" name="" value="SEND MAIL">
						</div>
						<a class="btn btn-success float-right mb-4" href="bloodrequest.php">Go Back</a>
					</form>
